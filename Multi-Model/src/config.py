...
# Image parameters
IMAGE_SIZE = (48, 48)
FER_INPUT_SHAPE = (*IMAGE_SIZE, 1)  # Grayscale input shape

# Audio parameters (Mel Spectrogram configuration)
AUDIO_SAMPLE_RATE = 16000
AUDIO_DURATION = 3  # seconds
AUDIO_N_MELS = 64    
AUDIO_N_FFT = 1024
AUDIO_HOP_LENGTH = 512
VER_INPUT_SHAPE = (None, AUDIO_N_MELS, 1)  # (time_steps, n_mels, channels)
...
# Training callbacks (updated with checkpoints)
COMMON_CALLBACKS = [
