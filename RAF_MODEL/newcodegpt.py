...
class ResEmoteNet(nn.Module):
    def __init__(self, num_classes=7):
        ...
        self.dropout = nn.Dropout(0.5)  # Added dropout before final layer
...
# Adjust the 'dataset_path' to your local RAF-DB dataset location.
...
# For Colab, you might set num_workers=2 or 0 if issues occur.
...
scheduler = CosineAnnealingWarmRestarts(optimizer, T_0=10, T_mult=2)  # Warm restarts scheduler
...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), "best_resemotenet_rafdb_gpt.pth")
